# python IMDB_Text_translation.py

'''Describe : 使用Sequence to Sequence 模型，英翻中
'''
...
# 訓練資料集
data_path = "C:/Users/user/Desktop/Data/AI/NLP/dataset/cmn.txt"
